...
<nav class="navbar navbar-expand vikNavbar">
    <div class="navbar-nav">
        ...
        <a class="nav-item nav-link vikA active" href="registr.php">
            <div class="vikABlok">
                регистрация
            </div>
        </a>
            ...
            <div class="w-25 mx-auto text-center">
                <form>
                    <div class="text-field text-field_floating">
                        ...
                        <p>(E-mail для регитсрации)</p>
                    </div>
                    <div class="text-field text-field_floating">
                        <input class="text-field__input" type="password" id="textPwd1" placeholder="">
                        <label class="text-field__label" for="textPwd1">Придумай пароль:</label>
                        <p>(Пароль от 6 до 10 знаков)</p>
                    </div>
                    <div class="text-field text-field_floating">
                        <input class="text-field__input" type="password" id="textPwd2" placeholder="">
                        <label class="text-field__label" for="textPwd2">Повтори пароль:</label>
                        <p>(Повторите пароль)</p>
                    </div>
                    <button type="submit" class="vikButton">РЕГИТСТРАЦИЯ</button>
                </form>
            </div>
        </div>
    </div>
